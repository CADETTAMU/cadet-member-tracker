...
class AffiliateOrgsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create affiliate_org' do
    assert_difference('AffiliateOrg.count') do
      post affiliate_orgs_url,
           params: { affiliate_org: { org_desc: @affiliate_org.org_desc, org_link: @affiliate_org.org_link,
                                      org_name: @affiliate_org.org_name } }
    end
  ...
  test 'should update affiliate_org' do
    patch affiliate_org_url(@affiliate_org),
          params: { affiliate_org: { org_desc: @affiliate_org.org_desc, org_link: @affiliate_org.org_link,
                                     org_name: @affiliate_org.org_name } }
